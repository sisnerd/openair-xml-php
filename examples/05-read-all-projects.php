...
$readCommand = new Read(['type' => "Project", 'method' => Read::METHOD_ALL, 'limit' => 25]);
...
// Each $user is a DataTypes/Project object
// Note: this leverages the __toString() method on Project class
foreach ($readResponses[0]->getResponseData() as $project) {
    echo " * " . $project . "\n";
}
